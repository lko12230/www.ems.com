					...
					if (user.isAccountNonLocked()) {
						if (user.getFailedAttempt() < UserServices.MAX_FAILED_ATTEMPTS - 1) {
							...
							String emailContent = "" + "<!DOCTYPE html>" + "<html lang='en'>" + "<head>"
									...
									+ "        .action-list li { margin-bottom: 10px; }" + "    </style>" + "</head>"
									+ "<body>" + "    <div class='email-container'>" + "        <div class='header'>"
									+ "            <h1>Failed Login Attempt</h1>" + "        </div>"
									+ "        <div class='content'>" + "            <p>Dear <b>" + username
									+ "</b>,</p>"
									...
									+ username + "</span></p>"
									+ "                <p><strong>Email:</strong> <span class='highlight'>" + email
									+ "</span></p>"
